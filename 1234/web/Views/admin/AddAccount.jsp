<%-- 
    Document   : AddAccount
    Created on : Jun 24, 2024, 10:15:06 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            .radio-group {
    display: flex; /* Sử dụng flexbox để bố trí các phần tử hàng ngang */
    align-items: center; /* Căn giữa các phần tử theo chiều dọc */
    justify-content: flex-start; /* Căn các phần tử về phía bắt đầu của container */
}

.radio-option {
    margin-right: 20px; /* Thêm khoảng cách giữa các lựa chọn */
}
...
.radio-option input[type="radio"] {
    ...
    <div class="radio-option">
        <input type="radio" id="unverified" name="status" value="unverified" checked>
    ...
    <div class="radio-option">
        ...
        <label for="inactive">Inactive</label>
            ...
            <div class="buttons">
                ...
                <button type="submit" class="update">Create New</button>
            </div>
        </div>
    </form>
</div>
