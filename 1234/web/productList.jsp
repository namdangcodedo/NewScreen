...
<body>
                ...
                <img src="images/main-logo.png" class="logo">
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 active" href="blog.html">Blogs</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu animate slide border">
                                    ...
                                    <li>
                                        <a href="cart.jspjsp" class="dropdown-item fw-light">Cart <span class="badge bg-primary">Pro</span></a>
                                    </li>
                                    <li>
                                        <a href="checkout.html" class="dropdown-item fw-light">Checkout <span class="badge bg-primary">Pro</span></a>
                                    </li>
                                    <li>
                                        <a href="blog.html" class="dropdown-item active fw-light">Blog <span class="badge bg-primary">Pro</span></a>
                                    </li>
                                    <li>
    ...
    <section class="padding-medium">
        ...
        <form action="processSelectedProducts" method="post">
            <a href="createProduct.jsp" class="btn button-right">Create new Product</a>
            <table class="product-table margin-medium">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="productDetail.jsp" class="btn button-right">Edit</a>
                        </td>
                    </tr>
                    <tr>
                        <td>002</td>
            ...
            <div class="button-container-right">
                <button type="button" class="btn">Export data</button>
            </div>
        </form>
        <div class="pagination margin-medium">
            <button type="button" class="btn">&laquo; Previous</button>
